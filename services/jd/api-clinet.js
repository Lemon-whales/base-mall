 ...
 * @LastEditors: wkiwi
 * @LastEditTime: 2020-10-13 11:06:53
 */
import HttpClient from "@/common/jd/http-client";
import AppConfig from "@/config/jd/app.config.js";
...
class ApiClient {
  ...
  request(options) {
    ...
    options.data.appid = AppConfig.APPID
    options.data.appkey = AppConfig.APPKEY
