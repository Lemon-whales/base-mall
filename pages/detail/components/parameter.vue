		...
		<view class="parameter text-28 animate-slide-up">
			...
			<scroll-view scroll-y class="scroll-view">
				<view class="parameter-wrapper">
					<view v-for="(item, index) in itemProperties" :key="index" class="item border-bottom padding-top-10 padding-bottom-10">
						<block v-for="(val, key, i) of item" :key="i">
			...
			<view class="close-box bg-white"><view class="close text-30" @click.stop="close">确定</view></view>
		</view>
	</view>
</template>
